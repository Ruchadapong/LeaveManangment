                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="{{route('department.edit',[$DepartmentDetails->id])}}" method="post"
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-8 col-md-6">
                                        <input type="text" id="department_name" name="department_name"
                                            value="{{$DepartmentDetails->department_name}}" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-4 col-md-3">
                                    ...
                                    <div class="col-8 col-md-6">
                                        <input type="text" id="department_abbr" name="department_abbr"
                                            value="{{$DepartmentDetails->department_abbr}}" class="form-control">
                                    </div>
                                </div>
